...
const NOVEL_PARAGRAPHS = [
  "لم يكن يعلم حين خرج من القرية تلك الليلة أن الطريق الذي اختاره سيغيّر كل ما يعرفه عن نفسه. الرياح كانت باردة، والقمر معلّق خلف غيوم رقيقة، وكل خطوة كانت تبعده أكثر عن الحياة التي عاشها طفلاً.",
  ...
  "مرّت الأيام ثقيلة كالحجر. كل صباح كان يبدأ بنفس السؤال: هل يستحق الأمر كل هذا العناء؟ وكل مساء كان يجد إجابة جديدة، مختلفة عن سابقتها، لكنها تقوده دائماً إلى نفس القرار: الاستمرار.",
  "عندما واجه الأمر أخيراً، لم يكن كما تخيّله. لم يكن هناك بريق سيف أو صرخة معركة، بل صمت ثقيل، وعينان تنظران إليه من الداخل كأنهما تعرفانه منذ زمن بعيد.",
  "الذكريات ليست شيئاً يمكن دفنه بسهولة. كانت تعود إليه في أضعف اللحظات، تتسلل بين أنفاسه وتذكّره بمن كان، وبمن يمكن أن يعود إليه إن لم يكن حذراً.",
  "قال المعلم العجوز، وهو يشير إلى الأفق البعيد: \"القوة الحقيقية لا تُقاس بما تهزمه، بل بما تختار أن ترحمه رغم قدرتك على تحطيمه.\"",
  "شعر بثقل الاختيار يجلس على كتفيه كجبل. لم يعد الأمر يتعلق به وحده؛ كل من يحبهم أصبحوا جزءاً من الميزان الذي يجب أن يوازنه بحكمة لم يكتسبها بعد.",
  "الميدان كان فارغاً إلا من صدى خطواته وضوء الفجر الزاحف على الحجارة القديمة. هنا، بين هذه الجدران المتهالكة، كانت القصة كلها قد بدأت — وهنا كان مقدَّراً لها أن تجد إجابتها.",
