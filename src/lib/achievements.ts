...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: "reader_50", title: "قارئ محترف", description: "اقرأ 50 فصلًا", icon: BookOpenCheck, metric: "chaptersRead", target: 50 },
  ...
  { id: "collector_20", title: "خزانة الروايات", description: "أضف 20 عملًا للمفضلة", icon: Bookmark, metric: "bookmarks", target: 20 },
  ...
  { id: "streak_30", title: "شهر بلا انقطاع", description: "اقرأ 30 يومًا متتاليًا", icon: Flame, metric: "streak", target: 30 },
