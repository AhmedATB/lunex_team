...
export function Footer() {
  return (
    <footer className="mt-16 border-t-2 border-white/25 bg-[#0c0715] pb-24 pt-10 lg:pb-10">
      ...
      <div className="container mt-8 border-t-2 border-white/20 pt-6 text-center text-xs text-lunex-gray">
