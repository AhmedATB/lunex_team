...
/**
 * "الفهرس" (Editorial Index) — opens on the hero spotlight, then text-forward
 * and list-based throughout: every series display here uses PaperListItem
 * (a reading-list row, no card/cover wall) so the rest of the page reads
 * like a table of contents rather than a gallery.
 */
