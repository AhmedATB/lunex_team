...
const RETENTION: { data: string; period: string }[] = [
  { data: "بيانات حسابك (البريد، والاسم، والنبذة، والصورة، والحسابات المرتبطة، والإشعارات، والمفضلة وسجل القراءة، ونقاط الخبرة والمستوى وسلسلة أيام القراءة وعدد الفصول المكتملة والإنجازات، ورصيد العملات ورصيد القراءة والفصول التي فتحتها وسجل عمليات العملات، وتعليقاتك، وسجل العقوبات، والجلسات والأجهزة)", period: "ما دام حسابك قائماً، وتُحذف فور حذفه" },
    ...
    <LegalPage title="سياسة الخصوصية" updated="25 سبتمبر 2026">
      ...
      <LegalSection title="البيانات التي نجمعها">
        ...
        <p>
          ...
          الأرقام على الخادم فقط. تظهر لك دائماً، ولا يراها غيرك إلا من سمحت لهم برؤية سجل القراءة، ولا تدخل قائمة أفضل القرّاء إلا إذا جعلت سجل القراءة عاماً.
        </p>
        ...
        <p>
          ...
          الفصول التي فتحتها، وسجلاً بعمليات العملات (كمية ونوع العملية وتاريخها، ومن أضافها). لا نعالج مدفوعات داخل الموقع: العملات تُضاف
          إلى حسابك يدوياً بعد الدفع عبر التواصل معنا على ديسكورد. لا يرى غيرك هذه الأرقام.
        </p>
        ...
        <p>
          لا نستخدم أدوات تحليل أو تتبّع خاصة بنا، ولا نجمع موقعك الجغرافي، ولا نعالج مدفوعات حالياً. الإعلانات الخارجية تُعرض في صفحات التصفح
      ...
      <LegalSection title="مع من نشارك بياناتك">
        <LegalList>
          <li>
            <Strong>شبكة الإعلانات:</Strong> يحمّل متصفحك كوداً منها في صفحات التصفح، وتجمع هي بيانات متصفحك
