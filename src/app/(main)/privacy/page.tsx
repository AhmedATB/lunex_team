...
const COOKIES: { name: string; purpose: string; duration: string; essential: boolean }[] = [
  ...
  { name: "lunex-consent", purpose: "يتذكّر اختيارك بخصوص ملفات تعريف الارتباط حتى لا نسألك كل زيارة.", duration: "6 أشهر", essential: true },  { name: "lunex-style", purpose: "يحفظ نمط ألوان الموقع الذي اخترته ليظهر بالشكل نفسه عند زيارتك التالية.", duration: "سنة", essential: false },
];
