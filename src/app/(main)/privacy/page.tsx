...
const RETENTION: { data: string; period: string }[] = [
  { data: "بيانات حسابك (البريد، والاسم، والنبذة، والصورة، والحسابات المرتبطة، والإشعارات، والمفضلة وسجل القراءة، وسجل العقوبات، والجلسات والأجهزة)", period: "ما دام حسابك قائماً، وتُحذف فور حذفه" },
  ...
  return (
    <LegalPage title="سياسة الخصوصية" updated="25 سبتمبر 2026">
      ...
      <LegalSection title="البيانات التي نجمعها">
        ...
        <p>
          في النسخة الحالية من الموقع تُحفظ هذه البيانات على جهازك ولا تصل إلى خوادمنا: التقييمات، والتعليقات، والرسائل، والمكافآت
      ...
      <LegalSection title="ملفات تعريف الارتباط والتخزين المحلي">
        ...
        <LegalList>
          <li>
            ...
            مفضلتك وتقدّم قراءتك، والتقييمات، والتعليقات، والرسائل، والمكافآت).
          </li>
          <li>
      ...
      <LegalSection title="حقوقك">
        ...
        <LegalList>
          ...
          <li>
            <Strong>نسخة من بياناتك:</Strong> زر «تنزيل بياناتي» يعطيك ملف JSON بكل ما نحفظه عنك، بما فيه مفضلتك وسجل قراءتك واختياراتك للخصوصية، ويشمل آخر 1000 سجل من كل نوع من سجلات الدخول والوصول.
          </li>
          <li>
